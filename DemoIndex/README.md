...
/Users/weichong/Documents/new_working_area/file_tree/PageIndex/.venv/bin/python -m DemoIndex.run run \
  --pdf-path /Users/weichong/Documents/new_working_area/file_tree/DemoIndex/docs/game2025report.pdf \
...
```bash
python -m DemoIndex.run run --pdf-path <pdf> [--write-postgres] [--write-global-index]
